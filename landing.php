...
<body>
  ...
  <section class="services" id="services">
    ...
    <div class="service-grid">
      ...
      <div class="service-card">
        ...
        <h3>Steam Press</h3>
        <p>Gentle steam ironing for a wrinkle-free finish.</p>
      </div>

      <div class="service-card">
        <i class="fa-solid fa-basket-shopping service-icon"></i>
        <h3>Commercial Laundry</h3>
        <p>Bulk cleaning for hotels, gyms, and hostels.</p>
      </div>
    </div>
  </section>
 ...
 <section class="contact" id="contact">
  <div class="section-header">
    <h2>Contact Us</h2>
    <p>Always happy to help — get in touch with us today!</p>
  </div>
  ...
  <div class="contact-wrapper">
    ...
    <div class="contact-info">
      ...
      <div class="info-card">
        ...
        <div>
          <h4>Address</h4>
          <p>G4 Fortune High Street, Adajan, Surat</p>
        </div>
      </div>
